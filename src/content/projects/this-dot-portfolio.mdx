...
description: Vance Tan's portfolio site built with React and Gatsby
tags: Personal
image: ../../assets/project-images/this-dot-portfolio.png
contributions: Frontend Development, UI/UX Design, Graphic Assets Design
tech: React, Gatsby, Styled Components, Javascript
source: https://github.com/vxncetxn/vancetan.dev
demo: null
---
